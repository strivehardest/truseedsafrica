  ...
  return (
    <section style={{
      ...
      <style>{`
        ...
        .hero-rule { width: 60px; height: 3px; background: ${COLORS.gold}; margin: 28px auto; }
        .hero-title {
        ...
        .hero-btn-primary {
          background: ${COLORS.gold}; color: ${COLORS.greenDark};
          padding: 18px 44px; text-decoration: none;
          font-family: 'Fira Sans', Arial, sans-serif; font-weight: 800;
          font-size: 13px; letter-spacing: 2px; text-transform: uppercase;
          border-radius: 2px; transition: background 0.2s, transform 0.2s; display: inline-block;
        }
        ...
        .hero-btn-secondary {
          ...
          font-size: 13px; letter-spacing: 2px; text-transform: uppercase;
          border-radius: 2px; transition: border-color 0.2s, color 0.2s; display: inline-block;
        }
        ...
        .hero-stat-num { font-size: 30px; font-weight: 800; color: ${COLORS.gold}; font-family: 'Plus Jakarta Sans', Arial, sans-serif; line-height: 1; margin-bottom: 6px; }
        .hero-stat-label { font-size: 10px; letter-spacing: 2px; text-transform: uppercase; color: rgba(255,255,255,0.35); font-family: 'Fira Sans', Arial, sans-serif; }
        ...
        .hero-scroll span { color: rgba(255,255,255,0.25); font-size: 10px; letter-spacing: 3px; text-transform: uppercase; font-family: 'Fira Sans', Arial, sans-serif; }
        .hero-scroll-line { width: 1px; height: 44px; background: linear-gradient(to bottom, ${COLORS.gold}70, transparent); }

        /* Agri floating elements */
        .hero-agri { position: absolute; pointer-events: none; opacity: 0.07; }

        @media (max-width: 640px) {
          .hero-stats { flex-wrap: wrap; gap: 24px; border-top: none; padding-top: 24px; }
          .hero-stat { border-right: none; max-width: 140px; }
      ...
      <div className="hero-inner">
        ...
        <div style={{ display: "inline-block", border: `2px solid ${COLORS.purple}`, padding: "2px", marginBottom: "36px" }}>
        ...
        <p style={{ fontSize: "clamp(12px, 1.6vw, 15px)", color: "rgba(255,255,255,0.4)", letterSpacing: "4px", textTransform: "uppercase", fontFamily: "'Fira Sans', Arial, sans-serif", margin: "0 0 24px" }}>
